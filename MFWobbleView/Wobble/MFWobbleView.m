...
- (void)display {
    ...
    for (NSInteger index = 0; index < wobbleCount; ++index) {
        ...
        char nameLB[30];
        char nameCenter[30];
        char nameDirection[30];
        char nameAmplitude[30];
        char nameTime[30];
        ...
        sprintf(nameCenter, "sketchs[%d].Center", (int)index);
        sprintf(nameDirection, "sketchs[%d].Direction", (int)index);
        sprintf(nameAmplitude, "sketchs[%d].Amplitude", (int)index);
        sprintf(nameTime, "sketchs[%d].Time", (int)index);
        ...
        GLuint Center = glGetUniformLocation(self.program, nameCenter);
        GLuint Direction = glGetUniformLocation(self.program, nameDirection);
        GLuint Amplitude = glGetUniformLocation(self.program, nameAmplitude);
        GLuint Time = glGetUniformLocation(self.program, nameTime);
        ...
        glUniform2f(Center, model.center.x, model.center.y);
